...
sealed interface List permits EmptyList, NonEmptyList {
  ...
  // static double reduce (List list, double identity, BinaryOperator<Interval> binaryOperator){
  //   return switch(list) {
  //     case EmptyList emptyList -> 0.0;
  //     case NonEmptyList nonEmptyList -> 
  //       binaryOperator.apply(
  //         nonEmptyList.element, 
  //         reduce(nonEmptyList.tail, identity, binaryOperator));
  //   };
  // }
